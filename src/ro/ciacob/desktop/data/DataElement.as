...
public class DataElement {
    ...
    public static function fromSerialized(serialized:ByteArray, cls:Class = null, fqn:String = null):Object {
        ...
        // If we reach down here, then we probably deal with a project file created in an older version of
        // MAIDENS (pre 1.5.7). We make another attempt of loading it using a legacy importer routine.
        return _legacyFromByteArray(serialized, cls);
    }

    /**
     * Slower deserialization routine to be used for loading projects produced by older versions of MAIDENS
     * (pre 1.5.7).
     *
     * @param   srcData
